println("loading run task functions")
#function take the runing state of the Arduino from process 1
running(Arduino_port) = @fetchfrom 1 ArduinosController[get(Arduino_dict,Arduino_port,0)]
#function change the runing state of the Arduino from process 1
